...
def describe_cases(cases, config, args):
    from inference.infer import validate_sampling, video_spec, text_only_canvas
...
def batch_plan(args, cases, config):
    from inference.infer import state_policy
...
def run_batch(args):
    from inference.infer import InferenceRuntime, generate
