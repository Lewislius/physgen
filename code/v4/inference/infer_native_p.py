...
DEFAULT_CHECKPOINT = ROOT / "checkpoints/wisa_native_p_A1_4x96g_20260912T151800Z-e189c27c/checkpoint-final"
...
class InferenceRuntime:
    ...
    def image_vae(self):
        if self.vae is None:
            self.vae = load_vae(self.config["paths"], self.device)
        else:
...
def build_parser():
    ...
    parser.add_argument("--demo-modes", choices=("both", "i2v", "t2v"), default="both")
